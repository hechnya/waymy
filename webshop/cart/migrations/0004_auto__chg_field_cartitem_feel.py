...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'CartItem.feel'
        db.alter_column('cart_items', 'feel_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['catalog.FeelName'], null=True))

    def backwards(self, orm):

        # Changing field 'CartItem.feel'
        db.alter_column('cart_items', 'feel_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['catalog.FeelName']))
    ...
    models = {
        'cart.cartitem': {
            ...
            'feel': ('django.db.models.fields.related.ForeignKey', [], {'default': '0', 'to': "orm['catalog.FeelName']", 'null': 'True'}),
