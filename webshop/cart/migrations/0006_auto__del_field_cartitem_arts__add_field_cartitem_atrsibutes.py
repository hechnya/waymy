...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'CartItem.arts'
        db.delete_column('cart_items', 'arts_id')
    ...
    def backwards(self, orm):
        # Adding field 'CartItem.arts'
        db.add_column('cart_items', 'arts',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['catalog.ProductVolume']),
                      keep_default=False)
    ...
    models = {
        'cart.cartitem': {
            ...
            'atrsibutes': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['catalog.ProductVolume']"}),
