...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('cart_items', (
            ...
            ('atributes', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['catalog.ProductVolume'])),
            ('feel', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['catalog.FeelName'], null=True)),
            ('cupon', self.gf('django.db.models.fields.related.ForeignKey')(default=2, to=orm['catalog.Cupon'], null=True, blank=True)),
        ))
