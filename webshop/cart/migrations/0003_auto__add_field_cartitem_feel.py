...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CartItem.feel'
        db.add_column('cart_items', 'feel',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['catalog.FeelName']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'CartItem.feel'
        db.delete_column('cart_items', 'feel_id')
    ...
    models = {
        'cart.cartitem': {
            ...
            'feel': ('django.db.models.fields.related.ForeignKey', [], {'default': '0', 'to': "orm['catalog.FeelName']"}),
