...
class HelperDelivery():
    ...
    def set_param(self):
        try:
            ...
            # s = self.sity
            # bool = u == s
            # for sity_tuple in DUMP:
            #     if unicode(sity_tuple[0], 'utf-8') == self.sity:
            #         test = unicode(sity_tuple[0], 'utf-8')
            #         print test
    ...
    def set_price(self):
        try:
            ...
            if self.weight <= 20000:
                test1 = self.weight // 500
                test2 = float(str(test1)) * self.plus
                test3 = test2 + self.start_price
