...
var Dajaxice = {
    ...
    webshop: {
        ...
        ajaxapp: {
            ...
            addToCart: function(callback_function, argv, custom_settings) {
                return Dajaxice.call('webshop.ajaxapp.addToCart', 'POST', callback_function, argv, custom_settings);
            }
        }
...
(function() {
    ...
    a.prototype.open = function(b, e, d, g, c) {
        ...
        this._object.onreadystatechange = function() {
            if (!m || d) {
                ...
                o(f);
                if (f._aborted)
                    f.readyState = a.UNSENT;
                else if (f.readyState == a.DONE) {
                    delete f._data;
                    l(f);
    ...
    a.prototype.addEventListener = function(a, e, d) {
        for (var g = 0, c; c = this._listeners[g]; g++)
            if (c[0] == a && c[1] == e && c[2] == d)
                return;
    ...
    a.prototype.dispatchEvent = function(a) {
        ...
        for (var e = 0, d; d = this._listeners[e]; e++)
            d[0] == a.type&&!d[2] && (d[1].handleEvent || d[1]).apply(this, [a])
    };
