...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Slider.link'
        db.add_column('slider_slider', 'link',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=200),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Slider.link'
        db.delete_column('slider_slider', 'link')
    ...
    models = {
        ...
        'catalog.product': {
            ...
            'itemsAttached': ('django.db.models.fields.related.ManyToManyField', [], {'related_name': "'itemsAttached_rel_+'", 'to': "orm['catalog.Product']"}),
            'meta_description': ('django.db.models.fields.CharField', [], {'max_length': '255', 'blank': 'True'}),
            'meta_keywords': ('django.db.models.fields.CharField', [], {'max_length': '255', 'blank': 'True'}),
        ...
        'slider.slider': {
            ...
            'text1': ('django.db.models.fields.CharField', [], {'max_length': '240'})
        }
    }
