...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'OrderItem.feel'
        db.alter_column('checkout_orderitem', 'feel_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['catalog.FeelName'], null=True))

    def backwards(self, orm):

        # Changing field 'OrderItem.feel'
        db.alter_column('checkout_orderitem', 'feel_id', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['catalog.FeelName']))
