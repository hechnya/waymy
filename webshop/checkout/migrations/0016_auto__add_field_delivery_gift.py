...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Delivery.gift'
        db.add_column('checkout_delivery', 'gift',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['catalog.GiftPrice'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Delivery.gift'
        db.delete_column('checkout_delivery', 'gift_id')
