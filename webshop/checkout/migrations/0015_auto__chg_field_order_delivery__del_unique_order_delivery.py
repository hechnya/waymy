...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing unique constraint on 'Order', fields ['delivery']
        db.delete_unique('checkout_order', ['delivery_id'])


        # Changing field 'Order.delivery'
        db.alter_column('checkout_order', 'delivery_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['checkout.Delivery'], null=True))

    def backwards(self, orm):

        # Changing field 'Order.delivery'
        db.alter_column('checkout_order', 'delivery_id', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['checkout.Delivery'], unique=True, null=True))
        # Adding unique constraint on 'Order', fields ['delivery']
        db.create_unique('checkout_order', ['delivery_id'])
