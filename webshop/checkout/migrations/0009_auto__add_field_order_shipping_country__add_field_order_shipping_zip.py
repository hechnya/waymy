...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('checkout_order', 'shipping_country',
                      self.gf('django.db.models.fields.CharField')(default='russia', max_length=50),
                      keep_default=False)

        # Adding field 'Order.shipping_zip'
        db.add_column('checkout_order', 'shipping_zip',
                      self.gf('django.db.models.fields.CharField')(default=234234, max_length=10),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Order.shipping_country'
        db.delete_column('checkout_order', 'shipping_country')

        # Deleting field 'Order.shipping_zip'
        db.delete_column('checkout_order', 'shipping_zip')
