...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Order.shipping_address_2'
        db.add_column('checkout_order', 'shipping_address_2',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=50, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Order.shipping_address_2'
        db.delete_column('checkout_order', 'shipping_address_2')
