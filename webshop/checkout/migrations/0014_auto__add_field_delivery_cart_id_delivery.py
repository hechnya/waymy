...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Delivery.cart_id_delivery'
        db.add_column('checkout_delivery', 'cart_id_delivery',
                      self.gf('django.db.models.fields.CharField')(default='0', max_length=50),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Delivery.cart_id_delivery'
        db.delete_column('checkout_delivery', 'cart_id_delivery')
