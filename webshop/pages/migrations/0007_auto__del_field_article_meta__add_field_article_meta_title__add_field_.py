...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column('pages_article', 'meta_id')

        # Adding field 'Article.meta_title'
        db.add_column('pages_article', 'meta_title',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=100),
                      keep_default=False)

        # Adding field 'Article.meta_description'
        db.add_column('pages_article', 'meta_description',
    ...
    def backwards(self, orm):
        ...
        db.add_column('pages_article', 'meta',
        ...
        db.delete_column('pages_article', 'meta_title')

        # Deleting field 'Article.meta_description'
        db.delete_column('pages_article', 'meta_description')
    ...
    models = {
        ...
        'pages.article': {
            ...
            'meta_description': ('django.db.models.fields.CharField', [], {'max_length': '240'}),
            'meta_title': ('django.db.models.fields.CharField', [], {'max_length': '100'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '100'}),
