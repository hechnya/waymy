...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('pages_page', (
            ...
            ('checkbox', self.gf('django.db.models.fields.CharField')(default='useful', max_length=20)),
        ))
    ...
    models = {
        'pages.page': {
            ...
            'checkbox': ('django.db.models.fields.CharField', [], {'default': "'useful'", 'max_length': '20'}),
