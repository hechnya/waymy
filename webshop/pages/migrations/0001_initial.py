...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.send_create_signal('pages', ['Article'])

        # Adding model 'Review'
        db.create_table('pages_review', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
            ('review', self.gf('django.db.models.fields.TextField')()),
        ))
        db.send_create_signal('pages', ['Review'])
    ...
    def backwards(self, orm):
        ...
        db.delete_table('pages_article')

        # Deleting model 'Review'
        db.delete_table('pages_review')

        # Deleting model 'Menu'
        db.delete_table('pages_menu')

        # Deleting model 'MetaInPages'
        db.delete_table('pages_metainpages')
