...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Page.meta'
        db.add_column('pages_page', 'meta',
        ...
        db.delete_column('pages_article', 'title')


    def backwards(self, orm):
        # Deleting field 'Page.meta'
        db.delete_column('pages_page', 'meta_id')
        ...
        db.add_column('pages_article', 'title',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)
