...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserProfile.icon'
        db.add_column('accounts_userprofile', 'icon',
                      self.gf('django.db.models.fields.files.FileField')(default='media/accounts/images/test.jpg', max_length=100),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserProfile.icon'
        db.delete_column('accounts_userprofile', 'icon')
