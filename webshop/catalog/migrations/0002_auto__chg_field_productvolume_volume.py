...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ProductVolume.volume'
        db.alter_column('product_volume', 'volume', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=9, decimal_places=2))

    def backwards(self, orm):

        # Changing field 'ProductVolume.volume'
        db.alter_column('product_volume', 'volume', self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=9, decimal_places=2))
