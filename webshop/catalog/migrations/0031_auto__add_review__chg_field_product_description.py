...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('products', 'description', self.gf('ckeditor.fields.RichTextField')())
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Product.description'
        db.alter_column('products', 'description', self.gf('django.db.models.fields.TextField')())
