...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'GiftPrice.description'
        db.alter_column('gift_price', 'description', self.gf('django.db.models.fields.TextField')(null=True))

    def backwards(self, orm):

        # Changing field 'GiftPrice.description'
        db.alter_column('gift_price', 'description', self.gf('ckeditor.fields.RichTextField')(null=True))
