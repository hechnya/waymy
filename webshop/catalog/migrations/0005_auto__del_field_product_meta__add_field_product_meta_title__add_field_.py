...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Product.meta_title'
        db.add_column('products', 'meta_title',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)

        # Adding field 'Product.meta_description'
        db.add_column('products', 'meta_description',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Product.meta_title'
        db.delete_column('products', 'meta_title')

        # Deleting field 'Product.meta_description'
        db.delete_column('products', 'meta_description')
