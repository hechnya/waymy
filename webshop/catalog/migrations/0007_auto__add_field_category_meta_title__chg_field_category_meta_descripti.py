...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('categories', 'meta_title',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=80, blank=True),
                      keep_default=False)


        # Changing field 'Category.meta_description'
        db.alter_column('categories', 'meta_description', self.gf('django.db.models.fields.CharField')(max_length=200))

    def backwards(self, orm):
        # Deleting field 'Category.meta_title'
        db.delete_column('categories', 'meta_title')


        # Changing field 'Category.meta_description'
        db.alter_column('categories', 'meta_description', self.gf('django.db.models.fields.CharField')(max_length=255))
    ...
    models = {
        ...
        'catalog.category': {
            ...
            'meta_description': ('django.db.models.fields.CharField', [], {'max_length': '200', 'blank': 'True'}),
            'meta_keywords': ('django.db.models.fields.CharField', [], {'max_length': '255', 'blank': 'True'}),
            'meta_title': ('django.db.models.fields.CharField', [], {'max_length': '80', 'blank': 'True'}),
