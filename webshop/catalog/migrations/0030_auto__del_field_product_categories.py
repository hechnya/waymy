...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column('products', 'categories_id')
    ...
    def backwards(self, orm):
        ...
        db.add_column('products', 'categories',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['catalog.Category']),
                      keep_default=False)
