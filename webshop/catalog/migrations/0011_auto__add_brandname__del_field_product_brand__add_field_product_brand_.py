...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column('products', 'brand')

        # Adding field 'Product.brand_name'
        db.add_column('products', 'brand_name',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['catalog.BrandName'], blank=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.delete_column('products', 'brand_name_id')
