...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ProductImage.new_image'
        db.alter_column('product_images', 'new_image', self.gf('django.db.models.fields.files.ImageField')(max_length=100))

    def backwards(self, orm):

        # Changing field 'ProductImage.new_image'
        db.alter_column('product_images', 'new_image', self.gf('pyuploadcare.dj.models.ImageField')())
    ...
    models = {
        ...
        'catalog.productimage': {
            ...
            'new_image': ('django.db.models.fields.files.ImageField', [], {'max_length': '100'}),
            'product': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['catalog.Product']"})
        },
