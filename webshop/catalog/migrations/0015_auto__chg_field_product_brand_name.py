...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Product.brand_name'
        db.alter_column('products', 'brand_name_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['catalog.BrandName'], null=True))

    def backwards(self, orm):

        # Changing field 'Product.brand_name'
        db.alter_column('products', 'brand_name_id', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['catalog.BrandName']))
