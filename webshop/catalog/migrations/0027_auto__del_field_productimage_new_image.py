...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'ProductImage.new_image'
        db.delete_column('product_images', 'new_image')


    def backwards(self, orm):
        # Adding field 'ProductImage.new_image'
        db.add_column('product_images', 'new_image',
                      self.gf('django.db.models.fields.files.ImageField')(default='deas.jpg', max_length=100),
                      keep_default=False)
