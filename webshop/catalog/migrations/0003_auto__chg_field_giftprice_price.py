...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'GiftPrice.price'
        db.alter_column('gift_price', 'price', self.gf('django.db.models.fields.DecimalField')(max_digits=9, decimal_places=2))

    def backwards(self, orm):

        # Changing field 'GiftPrice.price'
        db.alter_column('gift_price', 'price', self.gf('django.db.models.fields.CharField')(max_length=5))
